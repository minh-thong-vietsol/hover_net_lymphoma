...
if __name__ == "__main__":
    ...
    dataset_name = "kumar"
    save_root = "data/training_data/%s/" % dataset_name

    # a dictionary to specify where the dataset path should be
    dataset_info = {
        "train": {
            "img": (".tif", "data/kumar/train/Images/"),
            "ann": (".mat", "data/kumar/train/Labels/"),
        },
        "valid": {
            "img": (".tif", "data/kumar/test_same/Images/"),
            "ann": (".mat", "data/kumar/test_same/Labels/"),
        },
    }
